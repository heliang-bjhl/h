    ...
    var _p = {
        ...
        bind : function(){
            $('#btn_next').on('click',function(){
                $('#frmCreate').attr('action','next.j').trigger('submit');
            });
            $('#btn_save').on('click',function(){
                $('#frmCreate').attr('action','save.j').trigger('submit');
            });
        },
        ...
        setChangeRadio: function() {
            if ($('input[name="onlineRegistration"]').data('need') == 'noneed') {
                $('.c_unsee').hide();
            } else if ($('input[name="onlineRegistration"]').data('need') == 'need') {
                $('.c_unsee').show();
                validator.addItem({
                    element: '#z_startDate',
                    required: true,
